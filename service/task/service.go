...
// WrapRunner wraps the runner and returns a new one that runs the wrapped
// runner function only when service is activated.
//
// If service is nil, use DefaultService instead.
func WrapRunner(service *Service, r Runner) Runner {
