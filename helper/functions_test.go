...
func TestSet(t *testing.T) {
	...
	testSet(t, &d, "duration5", float32(102), time.Duration(102))
	testSet(t, &d, "duration6", float64(103), time.Duration(103))
	testSet(t, &d, "duration7", int(104), time.Duration(104))
	testSet(t, &d, "duration8", int8(105), time.Duration(105))
	testSet(t, &d, "duration9", int16(106), time.Duration(106))
	testSet(t, &d, "duration10", int32(107), time.Duration(107))
	testSet(t, &d, "duration11", int64(108), time.Duration(108))
	testSet(t, &d, "duration12", uint(109), time.Duration(109))
	testSet(t, &d, "duration13", uint8(110), time.Duration(110))
	testSet(t, &d, "duration14", uint16(111), time.Duration(111))
	testSet(t, &d, "duration15", uint32(112), time.Duration(112))
	testSet(t, &d, "duration16", uint64(113), time.Duration(113))
